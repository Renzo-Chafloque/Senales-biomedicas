...
> **Limitación:** El filtro elíptico presenta la respuesta de fase más no lineal de todos los filtros IIR clásicos. En aplicaciones donde la distorsión de fase es crítica (p.ej., análisis de morfología de onda en EKG o latencia de pico en EEG), puede requerirse aplicación bidireccional (`filtfilt`) o compensación de fase para preservar la forma de onda [5].
